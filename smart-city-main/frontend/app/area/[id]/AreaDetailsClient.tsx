...
export default function AreaDetailsPage() {
  ...
  const areaName = "Downtown District";
          ...
          <CardBody pt={2}>
            <VStack align="stretch" spacing={4}>
              ...
              <Flex align="center" justify="space-between">
                ...
                <Text fontWeight="semibold" fontSize="sm">32%</Text>
              </Flex>
              <Flex align="center" justify="space-between">
                <HStack spacing={2} color="gray.600">
                ...
                <Text fontWeight="semibold" fontSize="sm">24°C</Text>
              </Flex>
            </VStack>
          </CardBody>
        </Card>
            ...
            <VStack align="stretch" spacing={4}>
              ...
              <Box>
                <Flex align="center" justify="space-between" mb={1}>
                  ...
                  <Text fontSize="sm" fontWeight="medium">5 min</Text>
                </Flex>
              ...
              <Box>
                <Flex align="center" justify="space-between" mb={1}>
                  ...
                  <Text fontSize="sm" fontWeight="medium">98%</Text>
                </Flex>
          ...
          <CardBody>
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4}>
              <Card variant="elevated" bg="white" shadow="sm" borderLeftWidth={4} borderLeftColor="yellow.400">
                <CardHeader pb={2}><Heading size="xs" fontWeight="medium">Traffic Optimization</Heading></CardHeader>
                <CardBody pt={0}><Text fontSize="sm" color="gray.500">Adjust traffic light timings at 5th & Main during rush hour to reduce congestion by 15%.</Text></CardBody>
              </Card>
              <Card variant="elevated" bg="white" shadow="sm" borderLeftWidth={4} borderLeftColor="green.400">
                <CardHeader pb={2}><Heading size="xs" fontWeight="medium">Green Space Expansion</Heading></CardHeader>
                <CardBody pt={0}><Text fontSize="sm" color="gray.500">Potential zone for new vertical garden identified at Block C to improve micro-climate.</Text></CardBody>
              </Card>
              <Card variant="elevated" bg="white" shadow="sm" borderLeftWidth={4} borderLeftColor="blue.400">
                <CardHeader pb={2}><Heading size="xs" fontWeight="medium">Water Conservation</Heading></CardHeader>
                <CardBody pt={0}><Text fontSize="sm" color="gray.500">Detected localized pressure drop. Check for leaks in Sector 4 distribution network.</Text></CardBody>
              </Card>
            </SimpleGrid>
          </CardBody>
        </Card>
